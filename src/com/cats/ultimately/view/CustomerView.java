package com.cats.ultimately.view;

import com.cats.ultimately.domain.Customer;
import com.cats.ultimately.service.CustomerService;
...
public class CustomerView {
    ...
    private void addNewCustomer() throws SQLException {
        ...
        customer.setAge(age);
        System.out.print("地址 : ");
        String adderss = KeyboardUtility.readString(20);
    ...
    private void modifyCustomer () throws Exception {
        ...
        String gender = KeyboardUtility.readString(1, target.getGender());
        target.setGender(gender);
        System.out.print("年龄(" + target.getAge() + ") : ");
        int age = KeyboardUtility.readInt(target.getAge());
        target.setAge(age);
        System.out.print("地址(" + target.getAddress() + ") : ");
        String address = KeyboardUtility.readString(20,target.getAddress());
     ...
     * 员工列表
     */
    private void listAllCustomers() throws Exception {
        ...
        if (list == null || list.isEmpty()) {
            ...
            System.out.println("ID\t姓名\t\t性别\t\t年龄\t\t地址");
